...
const validateNonexistentPost = require('./middlewares/validateReq16');
// const validateReq16 = require('./middlewares/validateReq16');
...
// app.delete('/post/:id', validateToken, validateReq16, postController.deletePost);
